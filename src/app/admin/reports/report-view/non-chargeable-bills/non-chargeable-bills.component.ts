...
y = data.cursor.y;
    ...
    this.downloadService.saveAndOpenFile(doc.output('datauristring'),'Non-Chargeable Bill Wise Report' + new Date().toLocaleString() + '.pdf','pdf','application/pdf');
  }
  ...
  downloadExcel() {
    ...
    this.downloadService.saveAndOpenFile(
      base64Data,
      'Non-Chargeable Bill Wise Report' + new Date().toLocaleString() + '.csv','csv','text/csv');
  }
